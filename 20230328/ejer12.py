...
print('El sobrino de nuestro vecino pintor quiere controlar lo que le pagan por mes.')
...
PORSENTAJE_EXTRAS_HORAS = 40 / 100
PORSENTAJE_DESCUENTO_OBRA_SOCIAL = 6 / 100
PORSENTAJE_DESCUENTO_JUVILATORIO = 11 / 100
PORSENTAJE_HORAS_AUMENTO = 17 / 100


total_pago_horas_trabajadas = horas_trabajadas * pago_horas

pago_horas_extra = pago_horas + (pago_horas * (PORSENTAJE_EXTRAS_HORAS))
...
descuento_juvilatorio = total_pago_horas * (PORSENTAJE_DESCUENTO_JUVILATORIO)
descuento_obra_social = total_pago_horas * (PORSENTAJE_DESCUENTO_OBRA_SOCIAL)

total_descuentos = descuento_juvilatorio + descuento_obra_social

total_pago_extra = total_pago_horas_trabajadas * (PORSENTAJE_HORAS_AUMENTO)
